...
const dict = {
  ...
  'Salva palette': 'Save palette',
  'Palette salvata.': 'Palette saved.',
  'Palette salvata e applicata.': 'Palette saved and applied.',
  'Torna a Palette e stile': 'Back to Palettes & style',
  ...
  'Questa è la galleria delle palette: assegnano colori, font e dimensioni a tutti gli elementi del tema. Scegli quale applicare, oppure crea/modifica una palette da Style Studio (anche importando un file JSON condiviso). C’è sempre una palette attiva: se non ne scegli una, viene usata la prima.': 'This is the palette gallery: palettes assign colors, fonts and sizes to every theme element. Choose which one to apply, or create/edit a palette in Style Studio (you can also import a shared JSON file). There is always one active palette: if you do not choose one, the first is used.',
  'Nessuna palette disponibile. Crea la tua prima palette da Style Studio.': 'No palettes available. Create your first palette in Style Studio.',
