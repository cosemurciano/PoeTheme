...
function poetheme_get_design_settings_css() {
    ...
    // Solid header background follows the palette, EXCEPT the Split layout
    // (style 2) which is intentionally semi-transparent: there only the inner
    // frosted bar (.poetheme-header__main) carries the palette-tinted color.
    $styles .= 'body.poetheme-has-color-settings .poetheme-site-header:not(.poetheme-site-header--style-2){background-color:var(--poetheme-header-background-color) !important;box-shadow:var(--poetheme-header-shadow) !important;}';
    $styles .= 'body.poetheme-has-color-settings .poetheme-site-header--style-2{background-color:transparent !important;}';
    $styles .= 'body.poetheme-has-color-settings .poetheme-header--style-2 .poetheme-header__main{background-color:color-mix(in srgb, var(--poetheme-header-background-color) 85%, transparent) !important;}';
    if ( ! empty( $color_options['header_background_transparent'] ) || ( $header_color_defined && ! empty( $color_options['header_background_color'] ) ) ) {
        $styles .= 'body.poetheme-has-color-settings .poetheme-site-header:not(.poetheme-site-header--style-2){background-image:none !important;}';
    }
    $styles .= 'body.poetheme-has-color-settings .poetheme-nav--location-primary a:not(.poetheme-cta-button),body.poetheme-has-color-settings .poetheme-nav--location-primary-left a:not(.poetheme-cta-button),body.poetheme-has-color-settings .poetheme-nav--location-primary-right a:not(.poetheme-cta-button){color:var(--poetheme-menu-link-color) !important;background-color:var(--poetheme-menu-link-background) !important;}';
    $styles .= 'body.poetheme-has-color-settings .poetheme-nav--location-primary .current-menu-item > a:not(.poetheme-cta-button),body.poetheme-has-color-settings .poetheme-nav--location-primary .current_page_item > a:not(.poetheme-cta-button),body.poetheme-has-color-settings .poetheme-nav--location-primary a:not(.poetheme-cta-button):hover,body.poetheme-has-color-settings .poetheme-nav--location-primary a:not(.poetheme-cta-button):focus,body.poetheme-has-color-settings .poetheme-nav--location-primary-left .current-menu-item > a:not(.poetheme-cta-button),body.poetheme-has-color-settings .poetheme-nav--location-primary-left .current_page_item > a:not(.poetheme-cta-button),body.poetheme-has-color-settings .poetheme-nav--location-primary-left a:not(.poetheme-cta-button):hover,body.poetheme-has-color-settings .poetheme-nav--location-primary-left a:not(.poetheme-cta-button):focus,body.poetheme-has-color-settings .poetheme-nav--location-primary-right .current-menu-item > a:not(.poetheme-cta-button),body.poetheme-has-color-settings .poetheme-nav--location-primary-right .current_page_item > a:not(.poetheme-cta-button),body.poetheme-has-color-settings .poetheme-nav--location-primary-right a:not(.poetheme-cta-button):hover,body.poetheme-has-color-settings .poetheme-nav--location-primary-right a:not(.poetheme-cta-button):focus{color:var(--poetheme-menu-active-link-color) !important;background-color:var(--poetheme-menu-active-background) !important;}';
