...
if ( $show_cta && '' !== $cta_text ) {
    $cta_desktop = array(
        'text'  => $cta_text,
        'url'   => $cta_url,
        'class' => 'poetheme-cta-button inline-flex items-center px-5 py-2.5 rounded-lg bg-rose-600 text-white font-semibold shadow hover:bg-rose-700 transition',
    );
    $cta_mobile  = array(
        'text'  => $cta_text,
        'url'   => $cta_url,
        'class' => 'poetheme-cta-button inline-flex w-full justify-center items-center px-5 py-3 rounded-lg bg-rose-600 text-white font-semibold shadow hover:bg-rose-700 transition',
    );
}
