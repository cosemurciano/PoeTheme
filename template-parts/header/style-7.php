<?php
/**
 * Header layout: Style 7 (Stack | Left).
 *
 * @package PoeTheme
 */
...
if ( $show_cta && '' !== $cta_text ) {
    $cta_desktop = array(
        'text'  => $cta_text,
        'url'   => $cta_url,
        'class' => 'poetheme-cta-button inline-flex items-center px-4 py-2 rounded-full bg-orange-500 text-white font-semibold shadow hover:bg-orange-600 transition',
    );
    $cta_mobile  = array(
        'text'  => $cta_text,
        'url'   => $cta_url,
        'class' => 'poetheme-cta-button inline-flex w-full justify-center items-center px-5 py-3 rounded-full bg-orange-500 text-white font-semibold shadow hover:bg-orange-600 transition',
    );
}
        ...
        <div class="<?php echo esc_attr( poetheme_get_layout_container_classes( array( 'py-5' ) ) ); ?>">
            <div class="flex items-center justify-start">
                <div class="flex w-full items-center justify-between md:w-auto">
                    ...
                    <button type="button" class="poetheme-header__toggle poetheme-nav-toggle md:hidden text-gray-700" @click="mobileOpen = ! mobileOpen" :aria-expanded="mobileOpen.toString()" aria-controls="poetheme-mobile-menu" aria-haspopup="true">
